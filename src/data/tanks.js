...
const LIST = [
  ...
  { id: 'usa_t1', name: 'T1 Cunningham', short: 'T1', nation: 'usa', tier: 1, cls: 'light', parents: [],
    ...
    hull: { L: 3.9, W: 1.5, H: 1.05, clr: 0.35, track: { w: 0.32, h: 0.75, wheels: 4, wheelR: 0.2, style: 'leaf' },
  ...
  { id: 'usa_m2lt', name: 'M2 Light Tank', short: 'M2 LT', nation: 'usa', tier: 2, cls: 'light', parents: ['usa_t1'],
    ...
    hull: { L: 4.4, W: 1.6, H: 1.15, clr: 0.4, track: { w: 0.33, h: 0.8, wheels: 4, wheelR: 0.3, style: 'vvss' },
  ...
  { id: 'usa_m2med', name: 'M2 Medium Tank', short: 'M2 MT', nation: 'usa', tier: 3, cls: 'medium', parents: ['usa_m2lt'],
    ...
    hull: { L: 5.4, W: 1.8, H: 1.45, clr: 0.45, track: { w: 0.4, h: 0.9, wheels: 6, wheelR: 0.3, style: 'vvss' },
      upper: { t: 32, a: 45, frac: 0.45 }, lower: { t: 32, a: 25 }, side: { t: 25 }, rear: { t: 25, a: 10 }, roof: 13, floor: 10 },
    turret: { shape: 'box', z: 0.3, L: 1.5, W: 1.5, H: 0.85, ringR: 0.6, chamfer: 0.3,
  ...
  { id: 'usa_m3lee', name: 'M3 Lee', short: 'Lee', nation: 'usa', tier: 4, cls: 'medium', parents: ['usa_m2med'],
    ...
    hull: { L: 5.64, W: 1.88, H: 1.8, clr: 0.43, track: { w: 0.42, h: 0.95, wheels: 6, wheelR: 0.3, style: 'vvss' },
    ...
    look: { cupola: true, sponsonGun: true } },
  ...
  { id: 'usa_t1hvy', name: 'T1 Heavy Tank', short: 'T1 Hvy', nation: 'usa', tier: 5, cls: 'heavy', parents: ['usa_m3lee'],
    ...
    hull: { L: 7.5, W: 2.1, H: 1.85, clr: 0.5, track: { w: 0.52, h: 1.05, wheels: 8, wheelR: 0.3, style: 'hvss' },
  ...
  { id: 'usa_t29', name: 'T29', short: 'T29', nation: 'usa', tier: 7, cls: 'heavy', parents: ['usa_m6'],
    ...
    turret: { shape: 'box', z: -0.2, zOff: -0.15, L: 3.1, W: 2.8, H: 1.15, ringR: 1.2, chamfer: 0.2, gunY: 0.5,
  ...
  { id: 'ger_ltraktor', name: 'Leichttraktor', short: 'L.Tr.', nation: 'germany', tier: 1, cls: 'light', parents: [],
    ...
    hull: { L: 4.2, W: 1.55, H: 1.1, clr: 0.35, engine: 'front', track: { w: 0.3, h: 0.7, wheels: 6, wheelR: 0.2, style: 'leaf' },
  ...
  { id: 'ger_pz2', name: 'Pz.Kpfw. II', short: 'Pz. II', nation: 'germany', tier: 2, cls: 'light', parents: ['ger_ltraktor'],
    ...
    hull: { L: 4.8, W: 1.6, H: 1.1, clr: 0.35, track: { w: 0.3, h: 0.75, wheels: 5, wheelR: 0.28, style: 'leaf' },
  ...
  { id: 'ger_pzjg1', name: 'Panzerjäger I', short: 'Pz.Jg. I', nation: 'germany', tier: 2, cls: 'td', parents: ['ger_ltraktor'],
    ...
    hull: { L: 4.1, W: 1.4, H: 1.0, clr: 0.3, track: { w: 0.28, h: 0.7, wheels: 5, wheelR: 0.25, style: 'leaf' },
      upper: { t: 13, a: 22, frac: 0.5 }, lower: { t: 13, a: 60 }, side: { t: 13 }, rear: { t: 13, a: 10 }, roof: 8, floor: 5 },
    turret: { shape: 'casemate', open: true, z: 0.1, L: 1.4, W: 1.4, H: 0.9, gunY: 0.5, traverse: [-17, 17],
  ...
  { id: 'ger_pz38t', name: 'Pz.Kpfw. 38 (t)', short: 'Pz. 38t', nation: 'germany', tier: 3, cls: 'light', parents: ['ger_pz2'],
    ...
    hull: { L: 4.6, W: 1.55, H: 1.2, clr: 0.4, track: { w: 0.29, h: 0.78, wheels: 4, wheelR: 0.38, style: 'leaf' },
  ...
  { id: 'ussr_ms1', name: 'MS-1', short: 'MS-1', nation: 'ussr', tier: 1, cls: 'light', parents: [],
    ...
    hull: { L: 3.5, W: 1.3, H: 1.0, clr: 0.35, track: { w: 0.26, h: 0.65, wheels: 6, wheelR: 0.18, style: 'leaf' },
      upper: { t: 16, a: 40, frac: 0.5 }, lower: { t: 16, a: 35 }, side: { t: 16 }, rear: { t: 16, a: 5 }, roof: 8, floor: 8 },
    turret: { shape: 'box', z: -0.1, L: 1.1, W: 1.1, H: 0.7, ringR: 0.45, chamfer: 0.35,
  ...
  { id: 'ussr_t26', name: 'T-26', short: 'T-26', nation: 'ussr', tier: 2, cls: 'light', parents: ['ussr_ms1'],
    ...
    hull: { L: 4.62, W: 1.6, H: 1.05, clr: 0.38, track: { w: 0.3, h: 0.7, wheels: 8, wheelR: 0.18, style: 'leaf' },
      upper: { t: 15, a: 25, frac: 0.5 }, lower: { t: 15, a: 40 }, side: { t: 15 }, rear: { t: 15, a: 10 }, roof: 10, floor: 6 },
    turret: { shape: 'cast', z: -0.15, zOff: 0.05, L: 1.5, W: 1.5, H: 0.7, ringR: 0.6, chamfer: 0.45,
  ...
  { id: 'ussr_at1', name: 'AT-1', short: 'AT-1', nation: 'ussr', tier: 2, cls: 'td', parents: ['ussr_ms1'],
    ...
    hull: { L: 4.62, W: 1.6, H: 1.05, clr: 0.38, track: { w: 0.3, h: 0.7, wheels: 8, wheelR: 0.18, style: 'leaf' },
      upper: { t: 15, a: 25, frac: 0.5 }, lower: { t: 15, a: 40 }, side: { t: 15 }, rear: { t: 15, a: 10 }, roof: 10, floor: 6 },
    turret: { shape: 'casemate', z: -0.3, L: 1.9, W: 1.7, H: 0.95, gunY: 0.42, traverse: [-10, 10],
  ...
  { id: 'ussr_bt7', name: 'BT-7', short: 'BT-7', nation: 'ussr', tier: 3, cls: 'light', parents: ['ussr_t26'],
    ...
    hull: { L: 5.66, W: 1.63, H: 1.25, clr: 0.4, track: { w: 0.33, h: 0.82, wheels: 4, wheelR: 0.41, style: 'christie' },
      upper: { t: 20, a: 18, frac: 0.55 }, lower: { t: 20, a: 60 }, side: { t: 13 }, rear: { t: 13, a: 20 }, roof: 10, floor: 6 },
    turret: { shape: 'cast', z: 0.45, L: 1.7, W: 1.6, H: 0.7, ringR: 0.65, chamfer: 0.45,
  ...
  { id: 'ussr_t28', name: 'T-28', short: 'T-28', nation: 'ussr', tier: 4, cls: 'medium', parents: ['ussr_bt7'],
    ...
    hull: { L: 7.44, W: 2.1, H: 1.55, clr: 0.5, track: { w: 0.38, h: 0.95, wheels: 12, wheelR: 0.2, style: 'leaf' },
      upper: { t: 30, a: 25, frac: 0.45 }, lower: { t: 30, a: 50 }, side: { t: 20 }, rear: { t: 20, a: 10 }, roof: 15, floor: 15 },
    turret: { shape: 'box', z: 0.3, L: 1.9, W: 1.9, H: 0.85, ringR: 0.8, chamfer: 0.35,
  ...
  { id: 'ussr_su85', name: 'SU-85', short: 'SU-85', nation: 'ussr', tier: 5, cls: 'td', parents: ['ussr_su76'],
