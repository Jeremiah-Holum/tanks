...
export const CLASSES = {
  light: {
    ...
    hp: 90, armor: [26, 18, 14], pen: 64, dmg: 30, shellSpeed: 10.5, reload: 1.6,
  ...
  medium: {
    ...
    hp: 130, armor: [55, 34, 22], pen: 92, dmg: 42, shellSpeed: 11.5, reload: 2.2,
  ...
  heavy: {
    ...
    hp: 190, armor: [96, 56, 34], pen: 112, dmg: 56, shellSpeed: 10.5, reload: 3.0,
  ...
  td: {
    ...
    hp: 120, armor: [82, 28, 20], pen: 150, dmg: 70, shellSpeed: 13.5, reload: 3.4,
...
export const TYPES = {
  ...
  rookie: T('light', {
    name: 'Rookie', color: 0xc08a4a, trim: 0x5c3a1c, speed: 0, turnRate: 0, turretRate: 1.2, reload: 2.8, hp: 50, dmg: 22, pen: 56,
    ai: { think: 0.55, aimErr: 0.09, lead: false, dodge: false, fireTol: 0.09, mineUse: 0, style: 'hold', sweep: true, verify: 'loose' },
  }),
  grunt: T('medium', {
    name: 'Grunt', color: 0x8d949c, trim: 0x3a3f45, speed: 1.6, reload: 2.9, hp: 80, dmg: 28, pen: 80,
    ai: { think: 0.4, aimErr: 0.06, lead: false, dodge: false, dodgeLook: 0.3, fireTol: 0.07, mineUse: 0, style: 'wander', verify: 'loose' },
  }),
  zipper: T('light', {
    name: 'Zipper', color: 0x1fb5b0, trim: 0x0b4f4d, pen: 80, dmg: 28, hp: 60, reload: 2.4, shellSpeed: 14, rocket: true,
    ai: { think: 0.3, aimErr: 0.025, lead: true, dodge: true, dodgeLook: 0.35, fireTol: 0.04, mineUse: 0, style: 'sniper', verify: 'strict' },
  }),
  sapper: T('light', {
    name: 'Sapper', color: 0xd9ad2a, trim: 0x6b5208, mines: 4, hp: 60, dmg: 24,
  ...
  burst: T('medium', {
    name: 'Autoloader', color: 0xc8453c, trim: 0x5e1410, burst: 3, burstGap: 0.35, reload: 5.5, dmg: 22, hp: 90, maxShells: 3,
    ai: { think: 0.3, aimErr: 0.045, lead: true, dodge: true, dodgeLook: 0.35, fireTol: 0.05, mineUse: 0, style: 'wander', verify: 'strict' },
  }),
  ricochet: T('td', {
    name: 'Marksman', color: 0x5d8a2f, trim: 0x21470e, speed: 0, turnRate: 0, hp: 80, dmg: 48, pen: 120, reload: 3.8,
    ai: { think: 0.25, aimErr: 0.01, lead: true, dodge: false, fireTol: 0.02, mineUse: 0, style: 'hold', verify: 'strict' },
  }),
  hunter: T('medium', {
    name: 'Hunter', color: 0x7a4fc0, trim: 0x33145e, speed: 2.5, reload: 2.2, hp: 100, dmg: 34,
  ...
  ghost: T('light', {
    name: 'Ghost', color: 0xe4e4dc, trim: 0x9aa0a6, invisible: true, hp: 70, dmg: 28,
  ...
  boss: T('heavy', {
    name: 'Commander', color: 0x2e3034, trim: 0xd9a927, hp: 260, armor: [120, 70, 42], pen: 130, dmg: 56,
...
export const SKILLS = {
  ...
  ace:     { label: 'Ace',     think: 0.09, aimErr: 0.006, lead: true,  dodge: true, dodgeLook: 0.9,  dodgeEvery: 'tick',  fireTol: 0.02,  mineUse: 1,    verify: 'strict', counterFire: true,  tactics: true,  patience: 0.55, angle: true, flank: true },
};
