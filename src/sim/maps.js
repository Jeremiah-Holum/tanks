...
const SPECS = [
  ...
  M('Crossroads',      'town',    36, 26, 202, { g: 3, a: 1 }),
  M('Hedgerows',       'farm',    38, 26, 303, { g: 3, a: 2 }),
  M('Long Street',     'town',    40, 28, 404, { z: 2, g: 2, a: 1 }),
  M('Shell Holes',     'craters', 40, 28, 505, { g: 3, z: 2, a: 1 }, 1),
  M('Minefield',       'farm',    40, 28, 606, { y: 2, g: 3 }),
  M('Red Dawn',        'village', 42, 30, 707, { r: 2, z: 1, g: 2 }),
  M('Bank Shot',       'town',    42, 30, 808, { n: 2, g: 3 }),
  M('Mixed Company',   'craters', 44, 32, 909, { r: 1, z: 1, g: 2, a: 2, n: 1 }, 2),
  M('Purple Rain',     'river',   44, 32, 1010, { h: 2, g: 3 }, 1),
  M("Sappers' Maze",   'farm',    44, 32, 1111, { y: 3, g: 2, r: 1 }, 1, 1.3),
  M('Greenhouse',      'village', 44, 32, 1212, { n: 3, r: 1, h: 1 }, 1),
  M('Now You See Me',  'town',    44, 32, 1313, { w: 2, g: 3 }, 1),
  M('Pincer',          'river',   46, 32, 1414, { h: 3, z: 2 }, 2),
  M('The Gauntlet',    'fort',    46, 32, 1515, { r: 2, z: 2, h: 1, n: 1 }, 2),
  M('Sniper Alley',    'craters', 46, 32, 1616, { z: 3, n: 2, g: 2 }, 2),
  M('Haunted House',   'town',    46, 34, 1717, { w: 3, y: 1, h: 1 }, 2),
  M('Fortress',        'fort',    48, 34, 1818, { n: 2, h: 2, r: 2 }, 3),
  M('Elite Guard',     'town',    48, 34, 1919, { h: 3, w: 2, r: 1, n: 2 }, 3),
  M('The Commander',   'fort',    48, 34, 2020, { k: 1, h: 3, w: 1, n: 2 }, 3),
];
