...
export function kolvik(seed) {
  ...
  // ---------------- ground
  B.paint(GROUND.SNOW);
  B.both((T) => { const [x, z] = T.p([500, 450]); B.paintCircle(x, z, 60, GROUND.DIRT, 0.3); });
  ...
  B.lane('sawmill', [[570, 115], [700, 230], [800, 400], [750, railZ(750)], [770, 600], [650, 780], [430, 885]]);
  ...
  // ---------------- points
  B.point('sniper', 192, 408, 0, 0.25);                   // from the fort towards the NW
  B.point('sniper', 470, 300, 1, 0.1);
  B.point('sniper', 660, 260, 2, 0.1);
  B.point('hulldown', 250, 405, 0, 0.3, { snap: 26 });
  B.point('hulldown', 500, railZ(500) - 9, 1, 0, { snap: 10 });
